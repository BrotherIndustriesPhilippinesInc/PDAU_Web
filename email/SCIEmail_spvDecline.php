...
$mail = new \PHPMailer\PHPMailer\PHPMailer();
				...
				$mail->Subject = '[BIPH_PDAU] Declined Request - '.$RequestType.' ['. $requestID .']';
				...
				<p style="font-size:18px;">Your request for '.$RequestType.' SCI with RequestID ('.$requestID.') has been <span style="color:red"><b>Declined</b></span>.</p>
				...
				<td style="border:1px solid #dddddd; text-align:left;padding:8px;">'.$accounttype.'</td>
