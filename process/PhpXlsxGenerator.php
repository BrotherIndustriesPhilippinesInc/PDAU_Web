...
class PhpXlsxGenerator
{
    ...
    public function __construct()
    {
        $this->subject = '';
        $this->title = '';
        $this->author = 'PDAU-SCI System';
        $this->company = 'Brother Industries (Philippines) Inc.';
        $this->manager = 'Brother Industries (Philippines) Inc.';
        $this->description = '';
        $this->keywords = '';
        $this->category = '';
        $this->lastModifiedBy = 'PDAU-SCI System';
