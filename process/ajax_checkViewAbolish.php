...
$query3 = "SELECT COUNT(SCINo) as CheckSCI FROM SCI_MainData WHERE SCINo = '$sciNo' AND Status = 'Inactive'";
...
$query = "SELECT * FROM SCI_MainData WHERE SCINo = '$sciNo' AND Status = 'Inactive'";
