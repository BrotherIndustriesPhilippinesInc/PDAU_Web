    ...
    <div class="row">
      <div class="col-lg-12">
        ...
        <div class="card">
          ...
          <a class="btn btn-warning" style="color: black;" href="<?php echo $attachment;?>" target="_blank"><i class="bi bi-file-earmark-pdf" title="Click to View Request Attachment"></i> <b>Attachment</b></a>

          <a href="#" class="btn btn-info openModal" style="color: white" data-bs-toggle="modal" data-id="<?php echo $reqID;?>" data-bs-target="#modalHistory"  title="Click to View Transaction History"><i class="bi bi-clock-history"></i> <b>History</b></a>
          <br><br>
