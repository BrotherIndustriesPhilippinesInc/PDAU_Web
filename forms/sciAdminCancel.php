          ...
          <div class="row">
            <div class="col-12 overflow-auto">
                  <table id="example" class="table table-bordless" name="tblApproveReject" style="font-size:13px;">
                    ...
                    <tbody>
                <?php
                $sql = "SELECT * FROM SCI_Request WHERE RequestID IN(SELECT RequestID FROM SCI_Cancel WHERE Requestor = 'Admin') ORDER BY ID DESC";
