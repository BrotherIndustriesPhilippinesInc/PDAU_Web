        ...
        <div class="col-lg-12">
          <div class="row">
            <div class="col-12 overflow-auto">
                  <table id="example" class="table table-bordless" name="tblAbolished"  style="font-size:13px;">
                    <thead>
                      <tr>
                ...
                <?php
                if ($accountCode == 3) {
                  $sql = "SELECT * FROM SCI_MainData WHERE Status= 'Inactive' ORDER BY SCINo ASC";
                }
                else{
                  $sql = "SELECT * FROM SCI_MainData WHERE Section = '$section' AND Status='Inactive' ORDER BY SCINo ASC";
                }
                ...
                while($row = sqlsrv_fetch_array($stmt, SQLSRV_FETCH_ASSOC)) {
                  ...
                  $locationFile = "../SCI/".$Section."/Abolished/".$SCINo."/".$SCIFile."";
                   ...
                   if ($fileExt == 'pdf') {
                    ?>
                     <a href="<?php echo $locationFile; ?>" target="_blank" title="View Attachment" id="launchModal"><img src="../assets/img/pdf.png" width="25px;"></a>
                    <?php
                   }
                   else{
                    ?>
                      <a href="../process/watermark_img.php?location=<?php echo $locationFile; ?>" target="_blank" title="View Attachment" id="launchModal"><img src="../assets/img/pdf.png" width="25px;"></a>
                    <?php
                   }
                   ?>
